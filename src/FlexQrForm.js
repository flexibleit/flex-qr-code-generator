    ...
    return(
        <>
           <div className="flex-qr-code-form" id="flex-qr-code-form">
                ...
                <input type="hidden" name="_wp_http_referer" value="/Wordpress/wp-admin/admin.php?page=flexqr-code-generator"/><label for="version">Select QR Code Version:</label><select id="version" name="version" value={version} onChange={(e) => setVersion(e.target.value)}>
                        <option value="7">7</option>
                        <option value="8">8</option>
                        <option value="9">9</option>
                        <option value="10">10</option>
                </select><br/><br/><label for="circleRadius">Circle Radius (0.5 to 0.75):</label><input type="number" id="circleRadius" name="circleRadius" min="0.5" max="0.75" step="0.05" value={circleRadius} onChange={(e) => setCircleRadius(e.target.value)}/><br/><br/><table><tbody><tr><td><label for="flexqrcode_code_text">Enter text to encode in QR code:</label></td><td>
