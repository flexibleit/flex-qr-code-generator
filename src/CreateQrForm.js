                ...
                <div className="flex">
                    <div className="w-2/3">
                        <form onSubmit={handleSubmit} action="/Wordpress/wp-admin/admin.php?page=flexqr-code-generator" method="post" id="qrForm">    
                            ...
                            <div className="my-4">
                                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">QR Format::</label>
                                <select id="qr_code_format" name="qr_code_format" value={qrCodeFormat} onChange={(e) => setQrCodeFormat(e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
